  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative px-6 py-20 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center z-10 pt-20 pointer-events-none relative">
        ...
        >
            <a href="/Khushi_Resume.pdf" download="Khushi_Resume.pdf" className="px-8 py-3 rounded-full bg-[#FC8EAC] text-black font-semibold text-lg hover:bg-[#FC8EAC]/80 transition-colors flex items-center gap-2">
                Download CV
            </a>
